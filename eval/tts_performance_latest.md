...
- Passed: `4`
- Failed: `0`
- Mean latency: `1762.9` ms
- p95 latency: `2225.6` ms
- Mean RTF: `0.467`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `short_greeting` | `True` | `1863.2` | `1.521` | `1.225` | `-17.2` | `-3.9` | `0.0` | `0.2857` |
| `farmer_advice_medium` | `True` | `1625.3` | `6.18` | `0.263` | `-16.1` | `-1.3` | `0.0` | `0.1133` |
| `safety_message` | `True` | `1273.4` | `7.334` | `0.174` | `-15.9` | `-1.5` | `0.0` | `0.2044` |
| `long_voice_answer` | `True` | `2289.6` | `11.108` | `0.206` | `-16.0` | `-2.0` | `0.0` | `0.1673` |
